...
import { OMNIDEF } from './accountPlanInsertEnglish_def.js';
import tmpl from './accountPlanInsertEnglish.html';
import tmpl_nds from './accountPlanInsertEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountPlanInsertEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
